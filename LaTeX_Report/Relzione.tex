...
\item It is also important to emphasize that having intermediate layer results can actually improve the accuracy of the system. An example can be the VGG16 which achieves the maximum accuracy to 75% of the network length. Or still the Xception that reaches its maximum at 25%.
